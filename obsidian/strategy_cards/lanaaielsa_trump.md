...
- description: Strategy card for lanaaielsa_trump: entry=breakout, sentiment_tailwind; market_state=trend_or_acceleration.
- market: bullish
- timeframe: any
- creator: lanaaielsa
- confidence_bias: 0.11
- preferred_symbols: TRUMP
- avoided_symbols: none
- preferred_market_states: trend_or_acceleration
- entry_conditions: breakout, sentiment_tailwind
