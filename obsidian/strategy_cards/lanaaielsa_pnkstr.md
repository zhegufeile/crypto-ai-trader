...
- description: Strategy card for lanaaielsa_pnkstr: entry=breakout, volume_expansion, oi_rising; market_state=trend_or_acceleration.
- market: bullish
- timeframe: any
- creator: lanaaielsa
- confidence_bias: 0.15
- preferred_symbols: PNKSTR, REKTSTR, VIBESTR
- avoided_symbols: none
- preferred_market_states: trend_or_acceleration
- entry_conditions: breakout, volume_expansion, oi_rising
